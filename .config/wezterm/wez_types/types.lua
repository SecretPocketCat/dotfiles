...
---@param opts { moved_pane_id: number, split_pane_id: number }
function MuxWindow:move_pane_to_split(opts) end
...
---@param args { direction: 'Up' | 'Down' | 'Left' | 'Right', size?: { Cells: number } | { Percent: number }, command?: _.wezterm.SpawnCommand, top_level?: boolean, move_pane_id?: number }
---@return _.wezterm._KeyAssignmentAction
